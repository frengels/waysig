...
constexpr bool is_list_layout_compatible_v =
    (sizeof(wl_list) ==
     sizeof(ws::detail::intrusive_list<ws::detail::slot_base>)) &&
    (alignof(wl_list) ==
     alignof(ws::detail::intrusive_list<ws::detail::slot_base>));
constexpr bool is_signal_layout_compatible_v =
    (sizeof(wl_signal) == sizeof(ws::detail::signal_base)) &&
    (alignof(wl_signal) == alignof(ws::detail::signal_base)) &&
    (offsetof(wl_signal, listener_list) ==
     offsetof(ws::detail::signal_base, slot_list)) &&
    is_list_layout_compatible_v;
constexpr bool is_slot_layout_compatible_v =
    (sizeof(wl_listener) == sizeof(ws::detail::slot_base)) &&
    (alignof(wl_listener) == alignof(ws::detail::slot_base)) &&
    (offsetof(wl_listener, link) == offsetof(ws::detail::slot_base, link)) &&
    (offsetof(wl_listener, notify) == offsetof(ws::detail::slot_base, func)) &&
